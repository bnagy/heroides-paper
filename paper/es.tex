...
\begin{figure*}
  ...
  \subfigure[Accuracy by Author]{
    ...
    {/Users/ben/silius/ep15/ngram_acc_auth.pdf}
  }
  \qquad
  \subfigure[Accuracy by Work]{
    \includegraphics[width=0.45\textwidth]
    {/Users/ben/silius/ep15/ngram_acc_work.pdf}
  }
\end{figure*}
...
\label{fig:cm_ngrams}
\includegraphics[width=0.45\textwidth]{/Users/ben/silius/ep15/cm_ngrams_crop.pdf}
\end{figure}
...
\begin{figure*}
  ...
  \subfigure[Accuracy by Author]{
    \includegraphics[width=0.45\textwidth]
    {/Users/ben/silius/ep15/poetics_acc_auth-crop.pdf}
  }
  \qquad
  \subfigure[Accuracy by Work]{
    \includegraphics[width=0.45\textwidth]
    {/Users/ben/silius/ep15/poetics_acc_work-crop.pdf}
  }
\end{figure*}
...
\includegraphics[width=0.45\textwidth]{/Users/ben/silius/ep15/cm_poetics-crop.pdf}
\end{figure}
...
\begin{figure*}
  ...
  works by Propertius numbered by Book.]{
    ...
    {/Users/ben/silius/ep15/ele_metre_bct-crop.pdf}
  }
  \subfigure[UMAP Projection (metric=euclidean)]{
    \includegraphics[width=0.48\textwidth,keepaspectratio]
    {/Users/ben/silius/ep15/ele_metre_umap-crop.pdf}
  }
  \subfigure[t-SNE Projection (metric=euclidean, perplexity=12)]{
    \includegraphics[width=0.48\textwidth,keepaspectratio]
    {/Users/ben/silius/ep15/ele_metre_tsne-crop.pdf}
  }
\end{figure*}
...
\begin{figure*}
  ...
  \subfigure[SVM (relative distance from hyperplanes)]{
    \includegraphics[width=0.45\textwidth]
    {/Users/ben/silius/ep15/ampont_svm-crop.pdf}
  }
  \qquad
  \subfigure[Nearest centroid (Euclidean distance)]{
    \includegraphics[width=0.45\textwidth]
    {/Users/ben/silius/ep15/ampont_nc-crop.pdf}
  }
\end{figure*}
