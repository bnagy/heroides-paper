...
% use older latex until xwatermark bug is fixed 10/3/22
...
\citeA{kenney1999anomaly}, too, begins an article on the Double \emph{Heroides}
...
\begin{figure*}
  ...
  \label{fig:ampont}
  \centering
  \subfigure[SVM (relative confidence margins, based on distance from respective
  hyperplanes)]{
    \includegraphics[width=0.45\textwidth]
...
\citeA{stover_kestemont_2016}), further informs me (pers. comm.) that his own
